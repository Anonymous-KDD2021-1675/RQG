...
dPath=./data/${dname}/${dname}
   ...
   ./RQG/build/main ${dPath}.ds ${n} ${D} ${qn} ipnsw ${info_index} ${RQG_index} ${base_index} ${dPath}.mip -1

   ./ipnsw/build/main --mode database --database ${dPath}.ds --databaseSize ${n} --dimension ${D} --outputGraph ${base_index}
  
   ./RQG/build/main ${dPath}.q ${n} ${D} ${qn} ipnsw ${info_index} ${RQG_index} ${base_index} ${dPath}.mip ${K}
